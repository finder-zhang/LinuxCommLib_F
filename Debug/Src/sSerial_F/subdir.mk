...
Src/sSerial_F/SerialLinux_F.o: ../Src/sSerial_F/SerialLinux_F.cpp
	...
	g++ -DPRE_DEF_CPU_X86 -I"/root/workspace/CommLib_F/Src/sCommBase_F" -I"/root/workspace/CommLib_F/Src/sFileEx_F" -I"/root/workspace/CommLib_F/Src/sMathEx_F" -I"/root/workspace/CommLib_F/Src/sMemMonitor" -I"/root/workspace/CommLib_F/Src/sSerial_F" -I"/root/workspace/CommLib_F/Src/sThreadEx_F" -O0 -g3 -Wall -c -fmessage-length=0 -fPIC -MMD -MP -MF"$(@:%.o=%.d)" -MT"Src/sSerial_F/SerialLinux_F.d" -o "$@" "$<"
